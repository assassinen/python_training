...
def test_phones_on_db(app, db, data_contacts):
    ...
    for i in range(len(contact_from_home_page)):
        assert contact_from_home_page[i].paramentr['all_phone_from_home_page'] == merge_phone_like_on_home_page(contact_from_db[i])
        assert contact_from_home_page[i].paramentr['all_emal_from_home_page'] == merge_email_like_on_home_page(contact_from_db[i])
        assert contact_from_home_page[i].paramentr['lastname'] == contact_from_db[i].paramentr['lastname']
        assert contact_from_home_page[i].paramentr['firstname'] == contact_from_db[i].paramentr['firstname']
